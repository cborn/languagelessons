...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <style type="text/css">
			...
			*/
			#templateBody{
				#5ebf5e/*@editable*/ background-color:#F4F4F4;
				/*@editable*/ border-top:1px solid #FFFFFF;
				/*@editable*/ border-bottom:1px solid #CCCCCC;
			}
			/**
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateBody">
                                        <tr>
                                            <td valign="top" class="bodyContent" mc:edit="body_content">
                                                ...
                                                <br />
                                                <br />
                                                <div class="centre"><a class="btn btn-success" href=${link}>Unlock your account now!</a></div>
                                                <p><small>Note: This is a one use only link and will expire once used.</small></p>
                                                <br />
