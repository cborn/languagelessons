...
<html lang="en" class="no-js">
    <head>
        ...
        <title>Language Lessons - Set Account Password</title>
    </head>
    <body>
        ...
        <ul class="nav nav-tabs">
            ...
            <li class="nav active"><a href="#content" data-toggle="tab">Set Password</a></li>
        </ul>
            ...
            <div class="tab-pane fade in active" id="content">
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group col-xs-12">
                            <g:actionSubmit class="btn btn-default btn-lg center-block submit-button-green" name="setPassword" value="Set Password" action="processSetPassword" />
                        </div>
                    </div>
                </g:form>
                </div>
